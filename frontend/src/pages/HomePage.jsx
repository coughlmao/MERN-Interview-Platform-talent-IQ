...
const HomePage = () => {
  return (
    <div className="bg-linear-to-br from-base-100 via-base-200 to-base300">
      {/* NavBar */}
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadown-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          {/* Logo */}
          <Link className="flex items-center gap-3 hover:scale-105 transition-transform duration-200">
          ...
          <SignInButton mode="modal">
            <button className="group px-6 py-3 bg-linear-to-r from-primary to-secondary rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2">
              ...
              <ArrowRightIcon className="size-4 group-hover:translate-x-0.5 trnasition-transform" />
            </button>
          </SignInButton>
        </div>
      </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              The ultimate platoform for collaboratig coding interviews and pair
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">
            ...
            <span className="text-primary text-mono">Succeed</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Collaborate in real-time with syntax highlighting and mutltiple
                language support
              </p>
            </div>
          </div>
